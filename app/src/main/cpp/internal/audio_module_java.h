 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_cl_slack_patchfieldslack_patchfield_AudioModule_getProtocolVersion
  (JNIEnv *, jclass);
 ...
 * Signature: (III)J
 */
JNIEXPORT jlong JNICALL Java_com_cl_slack_patchfieldslack_patchfield_AudioModule_createRunner
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_cl_slack_patchfieldslack_patchfield_AudioModule_release
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_com_cl_slack_patchfieldslack_patchfield_AudioModule_hasTimedOut
  (JNIEnv *, jobject, jlong);
