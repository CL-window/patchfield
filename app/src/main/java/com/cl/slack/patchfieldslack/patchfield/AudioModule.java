...
import com.cl.slack.patchfieldslack.internal.SharedMemoryUtils;
...
public abstract class AudioModule {
     ...
     * Constructor.
     *
     * @param notification Notification to be passed to the Patchfield service, so that the service
     ...
     * @param name       Name of the new audio module in Patchfield.
     ...
     *
     * @param name
     * @param handle     Opaque handle to the internal data structure representing an
     *                   audio module.
     * @param sampleRate
     * @param bufferSize
